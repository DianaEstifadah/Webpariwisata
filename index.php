<?php
$title = " Wisata | Tempat Wisata | ticketing";
    ...
    <header class="masthead" style="height: 900px;">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in pt-5 mt-5">Selamat Datang di Website</div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row mb-3">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading text-uppercase text-white">Pilihan Informasi Wisata</h2>
                    <hr>
                </div>
            </div>
            <div class="row">
