...
function addticketku($a)
{
    global $knk;
    date_default_timezone_set("Asia/Jakarta");
    $id  = htmlspecialchars($a["id_artikel"]);
    $nomor_booking = htmlspecialchars($a["nomor_booking"]);
    $pemesan = htmlspecialchars($a["pemesan"]);
    $jumlah_tiket = htmlspecialchars($a["jumlah_tiket"]);
    $total_harga = htmlspecialchars($a["total_harga"]);
    $tanggal_booking = htmlspecialchars($a["tanggal_booking"]);

    $sts = "no yet approved";
    $insert = "INSERT INTO ticketing(no,nomor_booking,pemesan,jumlah_tiket,total_harga,tanggal_booking,id)
     VALUES ('','$nomor_booking','$pemesan','$jumlah_tiket','$total_harga','$tanggal_booking','$id')";
    // var_dump($insert);    die;
    mysqli_query($knk, $insert);
    return mysqli_affected_rows($knk);
}
...
function deletTicket($a)
{
    global $knk;
    $del = "DELETE FROM ticketing WHERE nomor_booking = '$a'";
    mysqli_query($knk, $del);
    return mysqli_affected_rows($knk);
}
...
function addtiket($a)
{
    ...
    $foto  = upload();
    $sts = "no yet approved";
    $insert = "INSERT INTO tiket(id,tempat,lokasi,isi,foto,date_create,time_create,date_update,time_update,sts)
     VALUES ('','$nama','$lokasi','$berita','$foto','$dateCreated','$timeCreated','$dateupdate','$timeUpdate','$sts')";
    // var_dump($insert);    die;
    mysqli_query($knk, $insert);
    return mysqli_affected_rows($knk);
