...
if (isset($_POST["saveTiket"])) {
    if (addticketku($_POST) > 0) {
        echo "
      <script>
        alert('Tiket anda berhasil');
                    ...
                    <div class="col-sm-3">
                        <div class="card card-primary border shadow-lg">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <a href="#" onclick="buka_modal()" class=" btn-md active mb-1">
                                <strong><i class="fas fa-ticket-alt" style= "margin-right: 10px;"></i> </i>Pesan Tiket</strong>
                                </a>
                                <hr>
                            </div>
                            <!-- /.card-body -->
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id_artikel" id="id_artikel" class="form-control" value="<?php echo $idArtikel ?>" id="id_artikel">
                    </div>
                    <div class="form-group">
                        <input type="text" name="nomor_booking" readonly id="nomor_booking" class="form-control" autofocus="true" autocomplete="off" value="<?php echo "KDR_".date('ymdhis') ;?>" placeholder="nomor booking" required>
                    </div>
                    
                    <div class="form-group">
                        <input type="text" name="pemesan" id="pemesan" class="form-control" autofocus="true" autocomplete="off" placeholder="pemesan" required>
                    </div>
                    <div class="form-group">
                        <input type="number" onkeyup="hitung_total()" name="jumlah_tiket" id="jumlah_tiket" class="form-control" autofocus="true" autocomplete="off" placeholder="jumlah tiket" required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="total_harga" readonly id="total_harga" class="form-control" autofocus="true" autocomplete="off" placeholder="Total" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="">Tanggal Booking</label>
                        <input type="date" name="tanggal_booking" id="tanggal_booking" class="form-control" autofocus="true" autocomplete="off" placeholder="tanggal booking" required>
                    </div>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" name="saveTiket" class="btn btn-success">
                    <i class="fas fa-save" style="margin-right: 10px;"></i>Pesan</button>
            </div>
        </form>
    </div>
    <!-- /.modal-content -->
...
<script>
function buka_modal(){
    $('#artikelAddModal').modal('show');
}
function hitung_total() {
    var total=0;
    var jumlah_tiket = $('#jumlah_tiket').val();
    total = parseInt(jumlah_tiket * 5000)
